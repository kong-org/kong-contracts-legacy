...
// The code below is from https://github.com/tdrerup/elliptic-curve-solidity

/**
 * @title   EllipticCurve
 * @notice  Implementation of elliptic curve math
 *
 * @author  Tilman Drerup; Includes code by Andreas Olofsson, Alexander Vlasov
 *          (https://github.com/BANKEX/CurveArithmetics), and Avi Asayag
 *          (https://github.com/orbs-network/elliptic-curve-solidity)
 * @dev     Currrently parametrized for SECP256R1; CAREFUL: Disambiguate public key in
 *          signature verification by activating condition 'rs[1] > lowSmax' in
 *          validateSignature().
 */
contract EllipticCurve {

    // Set constants for curve.
